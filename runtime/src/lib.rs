...
use sp_runtime::{
	MultiSigner, ApplyExtrinsicResult, generic, create_runtime_str, impl_opaque_keys, MultiSignature,
...
pub const VERSION: RuntimeVersion = RuntimeVersion {
	spec_name: create_runtime_str!("celer-network"),
	impl_name: create_runtime_str!("celer-network"),
	authoring_version: 1,
	spec_version: 1,
	impl_version: 1,
...
impl celer_pay_module::Trait for Runtime {
...
impl_runtime_apis! {
	...
	impl celer_pay_module_rpc_runtime_api::CelerPayModuleApi<Block, AccountId, Hash, Balance, BlockNumber> for Runtime {
