...
use celer_contracts_primitives::{ResolveResult, GetStorageResult, RentProjectionResult};
...
sp_api::decl_runtime_apis! {
		...
		Hash: Codec,
	{
		...
		/// Returns `Ok(Some(AccountId))` if the on-chain address exists under the given key in the
